let syllableData = {
  "openVowels": {
    ...
    "middle": ["ia","eo","ua","ai","oa","ie","ua","io","ae","ei","ou","ai","la","ri","na","ta","ka","sa","ma"],
    "suffix": ["ael","ion","iel","ua","eo","ai","ara","io","ae","iel","aen","iou"]
  },

  "harshConsonants": {
    "prefix": ["Gor","Brak","Thok","Krug","Zul","Vok","Drak","Grum","Krag","Thul","Bor","Drok","Zrak","Khal","Vruk","Ptak","Ktr","Zdr"],
    "middle": ["ak","or","ug","rak","mok","th","ok","urk","az","ok","uk","ar","ik","og","ul","pt","kt","zd","dr","gr","tr"],
    "suffix": ["th","g","ok","ar","um","ok","ak","or","ug","th","ok","ar","uk","um","oth","zt","kr"]
  },
